...
from transformers.utils import is_flash_attn_2_available, is_flash_attn_greater_or_equal_2_10, auto_docstring
...
def glm4v_text_model_forward(
    ...
    **kwargs,
    ...
    """
    Modified forward function for Glm4vTextModel to handle position_ids correctly.
    """
    ...
    # Import create_causal_mask from the correct location
